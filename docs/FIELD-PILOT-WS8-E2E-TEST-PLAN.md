...
| **T3** | **Cold power-pull**, twice (not a soft `reboot` — that does not reproduce a power cut) | verify green; both SSIDs beaconing within a recorded time; router's clock converges to server time |
